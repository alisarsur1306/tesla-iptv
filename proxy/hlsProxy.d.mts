...
export declare function handleDiag(req: IncomingMessage, res: ServerResponse): Promise<void>;
export declare function handleHealth(req: IncomingMessage, res: ServerResponse): Promise<void>;
